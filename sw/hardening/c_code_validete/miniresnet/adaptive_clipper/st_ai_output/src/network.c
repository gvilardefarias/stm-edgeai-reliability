...
#define AI_TOOLS_DATE_TIME   "2026-04-13T13:51:43+0200"
...
/* Array#15 */
AI_ARRAY_OBJ_DECLARE(
  conv2_block2_2_relu_clipper_output_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 3584, AI_STATIC)
...
/* Tensor #21 */
AI_TENSOR_OBJ_DECLARE(
  conv2_block2_2_relu_clipper_output, AI_STATIC,
  21, 0x0,
  AI_SHAPE_INIT(4, 1, 64, 7, 8), AI_STRIDE_INIT(4, 4, 4, 256, 1792),
  1, &conv2_block2_2_relu_clipper_output_array, NULL)
...
AI_STATIC_CONST ai_float conv2_block2_2_relu_clipper_nl_params_data[] = { 0, 36.835121154785156 };
AI_ARRAY_OBJ_DECLARE(
    conv2_block2_2_relu_clipper_nl_params, AI_ARRAY_FORMAT_FLOAT,
    conv2_block2_2_relu_clipper_nl_params_data, conv2_block2_2_relu_clipper_nl_params_data, 2, AI_STATIC_CONST)
AI_TENSOR_CHAIN_OBJ_DECLARE(
  conv2_block2_2_relu_clipper_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &conv2_block2_2_conv_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &conv2_block2_2_relu_clipper_output),
  AI_TENSOR_LIST_OBJ_EMPTY,
  AI_TENSOR_LIST_OBJ_EMPTY
)

AI_LAYER_OBJ_DECLARE(
  conv2_block2_2_relu_clipper_layer, 22,
  NL_TYPE, 0x0, NULL,
  nl, forward_clip,
  &conv2_block2_2_relu_clipper_chain,
  NULL, &conv2_block2_add_layer, AI_STATIC, 
  .nl_params = &conv2_block2_2_relu_clipper_nl_params, 
)
...
AI_LAYER_OBJ_DECLARE(
  conv2_block2_2_conv_layer, 21,
  CONV2D_TYPE, 0x0, NULL,
  conv2d, forward_conv2d_if32of32wf32,
  &conv2_block2_2_conv_chain,
  NULL, &conv2_block2_2_relu_clipper_layer, AI_STATIC, 
  .groups = 1, 
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 501544, 1, 1),
    501544, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  &conv1_conv_layer, 0xdb4d058f, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    conv2_block2_2_relu_clipper_output_array.data = AI_PTR(g_network_activations_map[0] + 14336);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    conv2_block2_2_conv_weights_array.data = AI_PTR(g_network_weights_map[0] + 210432);
    conv2_block2_2_conv_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 210432);
    conv2_block2_2_conv_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2_block2_2_conv_bias_array.data = AI_PTR(g_network_weights_map[0] + 357888);
    conv2_block2_2_conv_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 357888);
    new_head_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    new_head_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 358144);
    new_head_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 358144);
    new_head_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    new_head_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 501504);
    new_head_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 501504);
    return true;
  }
