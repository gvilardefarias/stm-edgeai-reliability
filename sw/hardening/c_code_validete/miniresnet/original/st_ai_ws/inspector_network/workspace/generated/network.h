...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "miniresnet_1stacks_64x50_tl"
...
#define AI_NETWORK_IN_1_WIDTH       (50)
#define AI_NETWORK_IN_1_CHANNEL     (1)
#define AI_NETWORK_IN_1_SIZE        (3200)
#define AI_NETWORK_IN_1_SIZE_BYTES  (12800)
