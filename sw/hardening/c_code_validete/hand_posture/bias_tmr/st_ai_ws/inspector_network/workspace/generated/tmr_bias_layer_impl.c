...
void custom_forward_TMRBiasLayer(ai_layer* layer)
{
  ...
  // Fetch the 3 separate weight tensors generated by Keras
  ai_tensor* t_weight0 = ai_layer_get_tensor_weights(l, 0); // b1
  ai_tensor* t_weight1 = ai_layer_get_tensor_weights(l, 1); // b2
  ai_tensor* t_weight2 = ai_layer_get_tensor_weights(l, 2); // b3

  ai_float *d_in  = ai_tensor_get_data(t_in0).float32;
  ai_float *d_out = ai_tensor_get_data(t_out0).float32;
  
  // Extract data pointers for each bias
