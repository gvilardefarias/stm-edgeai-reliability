...
#define AI_TOOLS_DATE_TIME   "2026-04-15T14:03:40+0200"
...
/* Array#3 */
AI_ARRAY_OBJ_DECLARE(
  dense_clipper_output_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 32, AI_STATIC)
...
/* Tensor #4 */
AI_TENSOR_OBJ_DECLARE(
  dense_clipper_output, AI_STATIC,
  4, 0x0,
  AI_SHAPE_INIT(4, 1, 32, 1, 1), AI_STRIDE_INIT(4, 4, 4, 128, 128),
  1, &dense_clipper_output_array, NULL)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &dense_clipper_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &dense_1_dense_output),
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  dense_clipper_chain, AI_STATIC_CONST, 4,
...
AI_LAYER_OBJ_DECLARE(
  dense_clipper_layer, 7,
  NL_TYPE, 0x0, NULL,
  nl, forward_clip,
  &dense_clipper_chain,
  NULL, &dense_1_dense_layer, AI_STATIC, 
  .nl_params = &dense_clipper_nl_params, 
)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    dense_clipper_output_array.data = AI_PTR(g_network_activations_map[0] + 128);
    dense_clipper_output_array.data_start = AI_PTR(g_network_activations_map[0] + 128);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 608);
    dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 608);
    dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 9824);
    dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 9824);
