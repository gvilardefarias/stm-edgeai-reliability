...
#define AI_TOOLS_DATE_TIME   "2026-03-25T18:15:48+0100"
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    conv2d_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 172);
    conv2d_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 172);
