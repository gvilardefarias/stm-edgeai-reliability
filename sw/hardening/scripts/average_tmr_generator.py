...
if __name__ == "__main__":
    ...
    if args.model == 'ign':
        ...
        target = "conv2d" 
        output_h5 = os.path.join(PRJ_ROOT, "sw/hardening/hardened_models/ign/HAR_avg_tmr.h5")
        ...
        target = "conv2d" 
        output_h5 = os.path.join(PRJ_ROOT, "sw/hardening/hardened_models/hand_posture/HAR_avg_tmr.h5")
        ...
        output_h5 = os.path.join(PRJ_ROOT, "sw/hardening/hardened_models/miniresnet/HAR_avg_tmr.h5")
