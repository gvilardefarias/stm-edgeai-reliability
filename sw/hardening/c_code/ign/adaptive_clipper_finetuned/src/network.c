...
#define AI_NETWORK_MODEL_SIGNATURE     "0x5fbf5a6cc895b011995d1b799b561b69"
...
#define AI_TOOLS_DATE_TIME   "2026-03-11T11:30:21+0100"
...
AI_STATIC_CONST ai_float conv2d_nl_params_data[] = { 0, 9.491317749023438 };
AI_ARRAY_OBJ_DECLARE(
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    conv2d_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 64);
    conv2d_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 64);
    conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 928);
    conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 928);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 1632);
    dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 1632);
    dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 12000);
    dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 12000);
    dense_1_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 12048);
    dense_1_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 12048);
    dense_1_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 12240);
    dense_1_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 12240);
    return true;
  }
