...
void custom_forward_MajorityVoterLayer(ai_layer* layer)
{
  ...
  ai_float *d_in0 = (ai_float *)ai_tensor_get_data(t_in0);
  ai_float *d_in1 = (ai_float *)ai_tensor_get_data(t_in1);
  ai_float *d_in2 = (ai_float *)ai_tensor_get_data(t_in2);
  ai_float *d_out = (ai_float *)ai_tensor_get_data(t_out0);
