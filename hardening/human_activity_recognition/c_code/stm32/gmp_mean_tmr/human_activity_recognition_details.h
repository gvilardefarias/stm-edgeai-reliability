...
const stai_network_details g_human_activity_recognition_details = {
  .tensors = (const stai_tensor[11]) {
   ...
   { .size_bytes = 3840, .flags = (STAI_FLAG_HAS_BATCH|STAI_FLAG_CHANNEL_LAST), .format = STAI_FORMAT_FLOAT32, .shape = {4, (const int32_t[4]){1, 20, 3, 16}}, .scale = {0, NULL}, .zeropoint = {0, NULL}, .name = "conv2d_mean_voter_left_0_output" },
   { .size_bytes = 3840, .flags = (STAI_FLAG_HAS_BATCH|STAI_FLAG_CHANNEL_LAST), .format = STAI_FORMAT_FLOAT32, .shape = {4, (const int32_t[4]){1, 20, 3, 16}}, .scale = {0, NULL}, .zeropoint = {0, NULL}, .name = "conv2d_mean_voter_output" },
  ...
  .nodes = (const stai_node_details[10]){
    ...
    {.id = 5, .type = AI_LAYER_ELTWISE_TYPE, .input_tensors = {2, (const int32_t[2]){4, 3}}, .output_tensors = {1, (const int32_t[1]){5}} }, /* conv2d_mean_voter_left_0 */
    {.id = 6, .type = AI_LAYER_ELTWISE_TYPE, .input_tensors = {2, (const int32_t[2]){5, 2}}, .output_tensors = {1, (const int32_t[1]){6}} }, /* conv2d_mean_voter */
    {.id = 7, .type = AI_LAYER_CONV2D_TYPE, .input_tensors = {1, (const int32_t[1]){6}}, .output_tensors = {1, (const int32_t[1]){7}} }, /* conv2d_1 */
    {.id = 8, .type = AI_LAYER_POOL_TYPE, .input_tensors = {1, (const int32_t[1]){7}}, .output_tensors = {1, (const int32_t[1]){8}} }, /* global_max_pooling2d_pool */
    {.id = 10, .type = AI_LAYER_DENSE_TYPE, .input_tensors = {1, (const int32_t[1]){8}}, .output_tensors = {1, (const int32_t[1]){9}} }, /* dense */
    {.id = 11, .type = AI_LAYER_SM_TYPE, .input_tensors = {1, (const int32_t[1]){9}}, .output_tensors = {1, (const int32_t[1]){10}} } /* activation */
  },
  .n_nodes = 10
};
#endif
