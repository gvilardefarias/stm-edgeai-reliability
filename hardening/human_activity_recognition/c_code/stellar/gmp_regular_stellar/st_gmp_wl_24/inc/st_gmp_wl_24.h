/**
  ...
  ******************************************************************************
  */
#ifndef STAI_ST_GMP_WL_24_H
#define STAI_ST_GMP_WL_24_H
...
#define STAI_ST_GMP_WL_24_ORIGIN_MODEL_NAME         "st_gmp_wl_24"
#define STAI_ST_GMP_WL_24_ORIGIN_MODEL_SIGNATURE    "0x399c1915c6eb56b231a6790e1a5f412c"

/*  Generated model name and signature  */
#define STAI_ST_GMP_WL_24_MODEL_NAME                "st_gmp_wl_24"
#define STAI_ST_GMP_WL_24_MODEL_SIGNATURE           (0xf08fe1f3ae3fef50)


/*****************************************************************************/
/*  Macros to declare network context size and required alignment  */
#define STAI_ST_GMP_WL_24_CONTEXT_ALIGNMENT   (8)
#define STAI_ST_GMP_WL_24_CONTEXT_SIZE        (sizeof(_stai_st_gmp_wl_24_context))

/*  Macro to declare network flags  */
#define STAI_ST_GMP_WL_24_FLAGS               (STAI_FLAG_WEIGHTS)

/*  Macro to declare number of network C nodes generated  */
#define STAI_ST_GMP_WL_24_NODES_NUM           (4)

/*  Macro to declare number macc for generated network model  */
#define STAI_ST_GMP_WL_24_MACC_NUM            (67168)

/*  Macros to declare input buffers characteristics  */
#define STAI_ST_GMP_WL_24_IN_NUM              (1)
#define STAI_ST_GMP_WL_24_IN_SIZE_BYTES       (292)

#define STAI_ST_GMP_WL_24_IN_ALIGNMENTS \
  { 4}
#define STAI_ST_GMP_WL_24_IN_NAMES \
  { NULL}
#define STAI_ST_GMP_WL_24_IN_FORMATS \
  { STAI_FORMAT_FLOAT32}
#define STAI_ST_GMP_WL_24_IN_SIZES \
  {72}
#define STAI_ST_GMP_WL_24_IN_SIZES_BYTES \
  {288}

#define STAI_ST_GMP_WL_24_IN_1_ALIGNMENT   (4)
#define STAI_ST_GMP_WL_24_IN_1_NAME        (NULL)
#define STAI_ST_GMP_WL_24_IN_1_FLAGS       (STAI_FLAG_INPUTS|STAI_FLAG_CHANNEL_LAST|STAI_FLAG_HAS_BATCH)
#define STAI_ST_GMP_WL_24_IN_1_FORMAT      (STAI_FORMAT_FLOAT32)
#define STAI_ST_GMP_WL_24_IN_1_SHAPE       {1,24,3,1}
#define STAI_ST_GMP_WL_24_IN_1_BATCH       (1)
#define STAI_ST_GMP_WL_24_IN_1_HEIGHT      (24)
#define STAI_ST_GMP_WL_24_IN_1_WIDTH       (3)
#define STAI_ST_GMP_WL_24_IN_1_CHANNEL     (1)
#define STAI_ST_GMP_WL_24_IN_1_RANK        (3)
#define STAI_ST_GMP_WL_24_IN_1_SIZE        (72)
#define STAI_ST_GMP_WL_24_IN_1_SIZE_BYTES  (288)

/*****************************************************************************/
/*  Macros to declare output buffers characteristics  */
#define STAI_ST_GMP_WL_24_OUT_NUM             (1)
#define STAI_ST_GMP_WL_24_OUT_SIZE_BYTES      (20)
#define STAI_ST_GMP_WL_24_OUT_ALIGNMENTS \
  { 4}
#define STAI_ST_GMP_WL_24_OUT_NAMES \
  { NULL}
#define STAI_ST_GMP_WL_24_OUT_FORMATS \
  { STAI_FORMAT_FLOAT32}
#define STAI_ST_GMP_WL_24_OUT_SIZES \
  { 4}
#define STAI_ST_GMP_WL_24_OUT_SIZES_BYTES \
  {16}

#define STAI_ST_GMP_WL_24_OUT_1_ALIGNMENT   (4)
#define STAI_ST_GMP_WL_24_OUT_1_NAME        (NULL)
#define STAI_ST_GMP_WL_24_OUT_1_FLAGS       (STAI_FLAG_OUTPUTS|STAI_FLAG_CHANNEL_LAST|STAI_FLAG_HAS_BATCH)
#define STAI_ST_GMP_WL_24_OUT_1_FORMAT      (STAI_FORMAT_FLOAT32)
#define STAI_ST_GMP_WL_24_OUT_1_SHAPE       {1,4}
#define STAI_ST_GMP_WL_24_OUT_1_BATCH       (1)
#define STAI_ST_GMP_WL_24_OUT_1_CHANNEL     (4)
#define STAI_ST_GMP_WL_24_OUT_1_RANK        (1)
#define STAI_ST_GMP_WL_24_OUT_1_SIZE        ((4))
#define STAI_ST_GMP_WL_24_OUT_1_SIZE_BYTES  (16)

/*****************************************************************************/
/*  Macros to declare activations buffers characteristics  */
#define STAI_ST_GMP_WL_24_ACTIVATIONS_SIZE              (7296)
#define STAI_ST_GMP_WL_24_ACTIVATIONS_SIZE_BYTES        (7296)
#define STAI_ST_GMP_WL_24_ACTIVATIONS_ALIGNMENTS \
  { 4}
#define STAI_ST_GMP_WL_24_ACTIVATIONS_SIZES \
  { 7296}
#define STAI_ST_GMP_WL_24_ACTIVATIONS_NUM               (1)

#define STAI_ST_GMP_WL_24_ACTIVATION_1_FLAGS      (STAI_FLAG_ACTIVATIONS)
#define STAI_ST_GMP_WL_24_ACTIVATION_1_SIZE       (7296)
#define STAI_ST_GMP_WL_24_ACTIVATION_1_SIZE_BYTES (7296)
#define STAI_ST_GMP_WL_24_ACTIVATION_1_ALIGNMENT  (4)
/*  Macros to declare weights buffers characteristics  */

#define STAI_ST_GMP_WL_24_WEIGHTS_NUM                  (1)
#define STAI_ST_GMP_WL_24_WEIGHTS_SIZE                  (5840)
#define STAI_ST_GMP_WL_24_WEIGHTS_SIZE_BYTES            (5840)
#define STAI_ST_GMP_WL_24_WEIGHTS_ALIGNMENTS \
  { 4}
#define STAI_ST_GMP_WL_24_WEIGHTS_SIZES \
  { 5840}
#define STAI_ST_GMP_WL_24_WEIGHTS_NUM        (1)
#define STAI_ST_GMP_WL_24_WEIGHT_1_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_ST_GMP_WL_24_WEIGHT_1_SIZE        (5840)
#define STAI_ST_GMP_WL_24_WEIGHT_1_SIZE_BYTES  (5840)


/*****************************************************************************/
/*  Macros to declare states buffers characteristics  */
#define STAI_ST_GMP_WL_24_STATES_SIZE              (0)
#define STAI_ST_GMP_WL_24_STATES_SIZE_BYTES        (0)
#define STAI_ST_GMP_WL_24_STATES_ALIGNMENTS        {}
#define STAI_ST_GMP_WL_24_STATES_SIZES             { 0, }
#define STAI_ST_GMP_WL_24_STATES_NUM               (0)

#define STAI_ST_GMP_WL_24_STATE_1_FLAGS            (0x0)
#define STAI_ST_GMP_WL_24_STATE_1_ALIGNMENT        (4)
#define STAI_ST_GMP_WL_24_STATE_1_SIZE             (0)
#define STAI_ST_GMP_WL_24_STATE_1_SIZE_BYTES       (0)
/*****************************************************************************/
...
typedef struct {
  ...
  stai_ptr                     _activations[STAI_ST_GMP_WL_24_ACTIVATIONS_NUM];
  stai_ptr                     _weights[STAI_ST_GMP_WL_24_WEIGHTS_NUM];
  stai_ptr                     _inputs[STAI_ST_GMP_WL_24_IN_NUM];
  stai_ptr                     _outputs[STAI_ST_GMP_WL_24_OUT_NUM];
} _stai_st_gmp_wl_24_context;
 ...
 *          @ref STAI_ST_GMP_WL_24_CONTEXT_SIZE or @ref stai_st_gmp_wl_24_get_context_size(void) API
 ...
 *          on the input buffers whose memory adresses are retrived using @ref stai_st_gmp_wl_24_get_inputs() API.
 *          Alternatively the application could allocate the inputs and set the addresses using the
 *          @ref stai_st_gmp_wl_24_set_inputs() API. Similar behaviour is expected for the network outputs handling.
 *          The features of each input / output buffer (format, byte size, etc.)may be queried using
 *          @ref stai_st_gmp_wl_24_get_info() API or the set of specific macros available in this header file.
 ...
 *          @ref stai_st_gmp_wl_24_get_outputs() API.
 * @param[in] network network context opaque pointer
 ...
 */
STAI_API_ENTRY
stai_size stai_st_gmp_wl_24_get_context_size(void);
 ...
 *          @ref stai_st_gmp_wl_24_set_states() dual API
 * @param[in] network network context opaque pointer
 ...
 *          @ref stai_st_gmp_wl_24_run() API. It is a helper routine that could be used by an application for debug
