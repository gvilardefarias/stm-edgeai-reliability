...
const stai_network_details g_human_activity_recognition_details = {
  ...
  .nodes = (stai_node_details[5]){
    {.id = 3, .type = AI_LAYER_CONV2D_TYPE, .input_tensors = {1, (int32_t[1]){0}}, .output_tensors = {1, (int32_t[1]){1}} }, /* conv2d */
    {.id = 4, .type = AI_LAYER_CONV2D_TYPE, .input_tensors = {1, (int32_t[1]){1}}, .output_tensors = {1, (int32_t[1]){2}} }, /* conv2d_1 */
    {.id = 5, .type = AI_LAYER_POOL_TYPE, .input_tensors = {1, (int32_t[1]){2}}, .output_tensors = {1, (int32_t[1]){3}} }, /* global_max_pooling2d_pool */
    {.id = 7, .type = AI_LAYER_DENSE_TYPE, .input_tensors = {1, (int32_t[1]){3}}, .output_tensors = {1, (int32_t[1]){4}} }, /* dense */
    {.id = 8, .type = AI_LAYER_NL_TYPE, .input_tensors = {1, (int32_t[1]){4}}, .output_tensors = {1, (int32_t[1]){5}} } /* activation */
  },
  .n_nodes = 5
};
#endif